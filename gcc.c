...
struct compiler compilers[] =
{
  ...
  {".i",
   "cc1 %i %1 %{!Q:-quiet} %{Y*} %{d*} %{m*} %{f*} %{a}\
	...
	%{S:%W{o*}%{!o*:-o %b.s}}%{!S:-o %{|!pipe:%g.s}} |\n\
    %{!S:asm %{R} %{j} %{J} %{h} %{d2} %a %{gg:-G %g.sym}\
     %{!v:+e} %{c:%W{o*}%{!o*:+o=%O%b.o}}%{!c:+o=%d%O%b.o} %{!pipe:%g.s}\n }"},
  {".s",
   "%{!S:asm %{R} %{j} %{J} %{h} %{d2} %a \
       %{!v:+e} %{c:%W{o*}%{!o*:+o=%b.r}}%{!c:+o=%d%b.r} %O%b.r %i\n }"},
  {".a",
   "%{!S:asm %{R} %{j} %{J} %{h} %{d2} %a \
       %{!v:+e} %{c:%W{o*}%{!o*:+o=%b.r}}%{!c:+o=%d%b.r} %O%b.r %i\n }"},
  {".S",
   "cpp %{nostdinc} %{C} %{v} %{D*} %{U*} %{I*} %{M*} %{trigraphs} \
    ...
    %{!M*:%{!E:%{!S:asm %{R} %{j} %{J} %{h} %{d2} %a \
            %{!v:+e} %{c:%W{o*}%{!o*:+o=%O%b.o}}%{!c:+o=%d%O%b.o}\
		    %{!pipe:%g.s}\n }}}"},
  /* Mark end of table */
  {0, 0}
};
...
/* Nonzero means %O has been seen; like %w but not on commandline  */
