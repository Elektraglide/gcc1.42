  ...
  "*
{
  ...
  if (GET_CODE (operands[1]) == MEM
	...
	labelref = XEXP (XEXP (operands[1], 0), 1);
      ...
      fprintf (asm_out_file, \"%s%d\\tequ *+2\\n\", \"LI\",
	       CODE_LABEL_NUMBER (XEXP (labelref, 0)));
#endif /* not SGS */
...
#else
      output_asm_insn (\"sub%.w %#2,%3\;move%.b %1,%2\", xoperands);
#endif
      return \"move%.w %+,%0\";
    }
...
#else
      output_asm_insn (\"move%.w %1,%-\;move%.b %2,%0\;add%.w %#2,%3\", xoperands);
#endif
...
#else
  return \"sub%.w %#1,%0\;cmp%.w %#-1,%0\;jbne %l1\";
#endif
#endif
#else /* not MOTOROLA */
